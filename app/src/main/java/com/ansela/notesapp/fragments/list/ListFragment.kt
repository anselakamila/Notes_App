package com.ansela.notesapp.fragments.list
...
import com.ansela.notesapp.databinding.FragmentListBinding
import com.ansela.notesapp.fragments.adapter.ListAdapter
import com.ansela.notesapp.fragments.update.SharedViewModels
import com.ansela.notesapp.utils.hideKeyboard
    ...
    override fun onCreateView(
       ...
       _listBinding = FragmentListBinding.inflate(inflater,container,false)
        ...
        mNotesViewModel.getAllData.observe(viewLifecycleOwner,{data ->
            mSharedViewModels.checkIdDatabaseEmpty(data)
